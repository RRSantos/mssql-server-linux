...
LABEL AUTHOR="Rodrigo Ramos <rodrigo.ramos.santos@gmail.com>"
...
COPY ./install-sqlpackage.sh            /usr/local/bin/
...
RUN apt update && apt install -y curl unzip libunwind8 libicu66
